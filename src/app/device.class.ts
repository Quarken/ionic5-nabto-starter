...
const FP_ACL_PERMISSION_ADMIN                 = 0x20000000;
const FP_ACL_SYSTEM_PERMISSION_LOCAL_ACCESS   = 0x80000000;
...
export class NabtoDevice {
  ...
  public openForPairing = false;
  public remoteAccessEnabled = false;
  public grantGuestRemoteAccess = false;
  public currentUserIsPaired = false;
  public currentUserIsOwner = false;
  public interfaceId = '';
  public interfaceVersionMajor = 0;
  public interfaceVersionMinor = 0;
  public hasInterfaceInfo = false;
